    ...
    <section id="about" className="relative py-28 overflow-hidden" ref={ref}>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div
              className="relative aspect-[4/5] w-full max-w-[340px] mx-auto rounded-2xl overflow-hidden"
            ...
            >
              ...
              <motion.div
                ...
                className="absolute bottom-5 left-4 right-4 glass rounded-xl px-4 py-3 flex items-center gap-3"
            ...
            <motion.div
              ...
              className="hidden lg:block absolute right-0 top-1/3 translate-x-1/2 glass-card px-6 py-4 text-center cursor-default"
              style={{ border: "1px solid rgba(245,158,11,0.25)", zIndex: 10 }}
            >
              <div className="text-3xl font-black gradient-text-warm mb-1" style={{ fontFamily: "var(--font-heading)" }}>1+</div>
              <div className="text-[10px] font-semibold uppercase tracking-widest whitespace-nowrap" style={{ color: "var(--fg-secondary)" }}>
                Years Exp.
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <p className="prose-muted text-base leading-relaxed mb-10">
            ...
            {/* Contact links */}
            <div className="space-y-4 mb-10" role="list" aria-label="Contact information">
            ...
            <div className="flex flex-wrap gap-2" role="list" aria-label="Professional skills">
              {softTags.map((skill, i) => (
                <motion.span
                  ...
                  animate={inView ? { opacity: 1, scale: 1 } : {}}
                  transition={{ duration: 0.3, delay: 0.5 + i * 0.07, ease: EXPO_OUT }}
